...
struct AnimationKey
{
	...
	bool AnimationKey::operator <(const float &b) const
	{
		return Tick < b;
	};

	friend bool operator <(const float &a, const AnimationKey &b)
	{
		return  a < b.Tick ;
	};
};
...
private:
	...
	TextureData* m_SourceTexture = nullptr;
	...
	static DirectX::XMUINT4 m_DefaultUInt4;
